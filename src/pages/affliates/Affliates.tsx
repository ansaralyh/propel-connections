          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-100 hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer text-center">
                <div className="mb-6">
                  <img src="/assets/tick.png" alt="No Upfront Fees" className="w-[29px] h-[29px] mx-auto" />
                </div>
                <h3 className="text-xl font-bold text-black mb-3">Verified Professionals</h3>
                <p className="text-gray-600 text-sm">Work with trusted and skilled experts</p>
              </div>

              {/* Feature 2 - Global Client Base */}
              <div className="bg-white p-6 rounded-2xl border border-gray-100 hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer text-center">
                <div className="mb-6">
                  <img src="/assets/material-symbols_payments-outline.png" alt="Global Client Base" className="w-[29px] h-[29px] mx-auto" />
                </div>
                <h3 className="text-xl font-bold text-black mb-3">Secure Payments</h3>
                <p className="text-gray-600 text-sm">Your money is safe until you approve the work</p>
              </div>

              {/* Feature 3 - Secure Payments */}
              <div className="bg-white p-6 rounded-2xl border border-gray-100 hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer text-center">
                <div className="mb-6">
                  <img src="/assets/person.png" alt="Secure Payments" className="w-[29px] h-[29px] mx-auto" />
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-100 hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer text-center">
                <div className="mb-6">
                  <img src="/assets/carbon_review.png" alt="Growth Opportunities" className="w-[29px] h-[29px] mx-auto" />
                </div>
                <h3 className="text-xl font-bold text-black mb-3">Customer Reviews</h3>
                <p className="text-gray-600 text-sm"> See feedback before hiring</p>
              </div>
            </div>
          </div>
        </div>
