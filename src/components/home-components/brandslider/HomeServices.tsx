  ...
  return (
    <section className="bg-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-8 items-center overflow-x-hidden overflow-y-hidden">
          ...
          <div className="flex-shrink-0 relative overflow-hidden rounded-2xl cursor-pointer transition-transform duration-300 hover:scale-105">
            <div className="w-73 h-75 relative">
              <img
                ...
                className="w-full h-full object-cover"
              />
              <div className="absolute bg-black bg-opacity-40 hover:bg-opacity-50 transition-all duration-300"></div>
